...
col_one_list = df['United States'].tolist()
col_one_list = col_one_list[150:400]
print(col_one_list)

susceptible_list = [328000000]
infected_list = [330112.0]
recoverd_list = [0]
...
plt.xlabel("Biweekly")
plt.ylabel("Cases, *10e6")
plt.title("Biweekly Cases in The United States of America, Actual and Predicted")
plt.xlim([0, 400])
